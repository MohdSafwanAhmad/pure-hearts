    ...
    <main className="container mx-auto max-w-4xl px-6 py-12">
      ...
      <section className="space-y-6">
        <div>
          ...
          <p>
            These Terms & Conditions govern your use of the website, applications, and
            services operated by <strong>Pure Hearts</strong>. By using our
        ...
        <div>
          ...
          <p>
            You must be at least 18 years old or have parental/guardian consent to use our
            services. By using our platform, you confirm that you meet these
            requirements.
          </p>
        </div>
        ...
        <div>
          ...
          <ul className="list-disc pl-6 space-y-2">
            ...
            <li>Refrain from misusing the platform or engaging in unlawful activity.</li>
          </ul>
        </div>
        ...
        <div>
          ...
          <p>
            All donations or payments are voluntary and non-refundable unless otherwise
            required by law. We reserve the right to decline or refund any transaction at
            our discretion.
          </p>
        </div>
        ...
        <div>
          ...
          <p>
            All content, trademarks, and designs on this platform are the property of
        ...
        <div>
          ...
          <p>
            ...
            resulting from your use of the platform, except where prohibited by law.
          </p>
        </div>
