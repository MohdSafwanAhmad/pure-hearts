...
export function OrganizationSignupForm() {
  ...
  const renderStep = () => {
    ...
    switch (currentStep) {
      case 1:
        return <BasicInformationSection {...sectionProps} />;
      case 2:
    ...
    <div className="flex flex-col gap-6">
      <Card className="overflow-hidden p-0">
        <CardContent className="p-0">
          <form
            action={() => {
              // Merge our state data into the FormData for submission
              const mergedFormData = prepareFormData();
              return signupAction(mergedFormData);
            }}
              ...
              <Card>
                ...
                <CardContent>
                  ...
                  {currentStep === totalSteps && (
                    <div className="mt-4">
                      <FieldErrorsSummary errors={signupState?.errors || {}} />
                    </div>
                  )}
                </CardContent>
              </Card>
